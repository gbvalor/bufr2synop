...
/*!
  \fn int climat_parse_x11 ( struct climat_chunks *b, struct bufr2tac_subset_state *s )
  \brief Parse a expanded descriptor with X = 11
...
/*!
  \fn int temp_parse_x11 ( struct temp_chunks *b, struct bufr2tac_subset_state *s )
  \brief Parse a expanded descriptor with X = 11
